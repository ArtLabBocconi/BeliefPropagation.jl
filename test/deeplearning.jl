...
for lay in [:tapex] #TODO  :bpex non ce la fa
    @time g, W, E, stab = DeepBinary.solve(α=0.2, K=[401,21,3,1]
                , layers=[:tap,lay,lay]
                ,r=.92,rstep=0.001, ry=0.0, seedξ=1,maxiters=2000);
    @test E == 0
end
...
# @time g, W, E, stab = DeepBinary.solve(α=0.25, K=[301,21,11,3,1]
...
@time g, W, E, stab = DeepBinary.solve(α=0.2, K=[301,21,11,3,1]
